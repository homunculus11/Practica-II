...
public class ConsoleText {
    ...
    public static String normalizeCertification(String value) {
        List<String> allowed = Arrays.asList("Fara grad didactic", "Grad didactic II", "Grad didactic I", "Grad didactic superior");
        return allowed.contains(value) ? value : "Fara grad didactic";
    }
